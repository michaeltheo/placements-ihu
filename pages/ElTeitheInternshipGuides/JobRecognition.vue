                  ...
                  <tr class="guide__container__stepper__table-row">
                    ...
                    <td>
                      <v-btn
                        ...
                        @click="
                          openFile(
                            `${AnagronisiErgasiasUrls.ILEKTRONIKI.AitisiPraktikisAskisis}`
                          )
                        "
                      >
                  ...
                  <tr class="guide__container__stepper__table-row">
                    ...
                    <td>
                      <v-btn
                        ...
                        @click="
                          openFile(
                            `${AnagronisiErgasiasUrls.ILEKTRONIKI.AitisiAnagnorisis}`
                          )
                        "
                      >
                        <v-icon size="large" color="primary-blue-color"
                  ...
                  <tr class="guide__container__stepper__table-row">
                    ...
                    <td>
                      <v-btn
                        ...
                        @click="
                          openFile(
                            `${AnagronisiErgasiasUrls.ILEKTRONIKI.BebaiosiApasxolisisKaiAsfalisisAskoumenou}`
                          )
                        "
                      >
                        <v-icon size="large" color="primary-blue-color"
                  ...
                  <tr class="guide__container__stepper__table-row">
                    ...
                    <td>
                      <v-btn
                        ...
                        @click="
                          openFile(
                            `${AnagronisiErgasiasUrls.ILEKTRONIKI.BebaiosiOlokrirosisPraktikisAskisis}`
                          )
                        "
                      >
                        <v-icon size="large" color="primary-blue-color"
                  ...
                  <tr class="guide__container__stepper__table-row">
                    ...
                    <td>
                      <v-btn
                        ...
                        @click="
                          openFile(
                            `${AnagronisiErgasiasUrls.ILEKTRONIKI.AitisiOloklirosisPraktikisAskisis}`
                          )
                        "
                      >
                        <v-icon size="large" color="primary-blue-color"
...
.guide {
  ...
  &__container {
    ...
    &--header {
      @apply md:text-4xl text-3xl font-extrabold mb-6 leading-snug text-center;
    ...
    &__stepper {
      @apply mt-10 text-xl font-medium mb-5 space-y-8;
      color: $primary-blue-color;
      ...
      &__requirements {
        @apply p-10 rounded-lg shadow-2xl bg-gray-50;

        &__text {
          @apply mt-2 text-xl mb-5;
          color: $primary-blue-color;
        }
        ...
        &__note {
          @apply text-red-500 font-bold mt-5;
        }
      }

      &__table {
        @apply text-lg font-medium mt-5;
        color: $primary-dark-blue-color;
        width: 100%;
