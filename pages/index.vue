    ...
    <div class="home-page__grid-section">
      <div class="home-page__grid-section-info">
        ...
        <div class="home-page__grid-section-content">
          ...
          <p class="pt-2">
            Μέσω του κεντρικού μενού μπορείτε να ενημερωθείτε για τις
            προϋποθέσεις που πρέπει να πληρούνται, προκειμένου να μπορείτε να
            εκπονήσετε πρακτική άσκησης, καθώς επίσης και για όλα τα
            δικαιλογητικά που θα χρειαστεί να υποβάλετε για κάθε πρόγραμμα
            πρακτικής.
          </p>
        </div>
      </div>
