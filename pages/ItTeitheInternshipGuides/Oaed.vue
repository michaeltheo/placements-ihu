                  ...
                  <tr class="guide__container__stepper__table-row">
                    ...
                    <td>
                      <v-btn
                        ...
                        @click="
                          openFile(
                            `${OAEDUrls.PLIROFORIKI.AitisiPraktikisAskisis}`
                          )
                        "
                      >
                  ...
                  <tr class="guide__container__stepper__table-row">
                    ...
                    <td>
                      <v-btn
                        ...
                        @click="
                          openFile(
                            `${OAEDUrls.PLIROFORIKI.AitisiForeaApasxolisisFoititi}`
                          )
                        "
                      >
                        <v-icon size="large" color="primary-blue-color"
                  ...
                  <tr class="guide__container__stepper__table-row">
                    ...
                    <td>
                      <v-btn
                        ...
                        @click="
                          openFile(
                            `${OAEDUrls.PLIROFORIKI.BebaiosiApasxolisisKaiAsfalisisAskoumenou}`
                          )
                        "
                      >
                        <v-icon size="large" color="primary-blue-color"
                  ...
                  <tr class="guide__container__stepper__table-row">
                    ...
                    <td>
                      <v-btn
                        ...
                        @click="
                          openFile(
                            `${OAEDUrls.PLIROFORIKI.BebaiosiOlokrirosisPraktikisAskisis}`
                          )
                        "
                      >
                        <v-icon size="large" color="primary-blue-color"
                  ...
                  <tr class="guide__container__stepper__table-row">
                    ...
                    <td>
                      <v-btn
                        ...
                        @click="
                          openFile(
                            `${OAEDUrls.PLIROFORIKI.AitisiOloklirosisPraktikisAskisis}`
                          )
                        "
                      >
                        <v-icon size="large" color="primary-blue-color"
